    ...
    <section className="p-4 ">
      ...
      <div className="space-y-4">
        <div className="rounded-none ">
          {/* Category Label */}
          <span className="text-xs text-[#ECB731] font-haas font-semibold">
            STREET SMART
          </span>
          ...
          <p className="text-sm text-gray-700 mt-1">
            In trying to keep costs in check at his loss-making airline,
            chairman Ajay Singh may have created a toxic work atmosphere and
            poor safety culture.
          </p>
        ...
        {articles.concat(articles).map((article, index) => (
          <div key={index} className="rounded-lg ">
            ...
            {/* Title */}
            <h3 className=" text-xl text-black font-playfair font-bold mt-2">
              {article.title}
            </h3>
        ...
        <section className="flex flex-col items-center p-2 space-y-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {categories.map((category, index) => (
              <span
                key={index}
                className="px-4 py-2 text-[#7B8FFE] border-0.75 border-[#7B8FFE] rounded-full text-sm font-medium font-haas"
          ...
          {/* Subscribe Button */}
          <button className="px-6 py-3 bg-gradient-to-r w-full from-[#43CEBD] to-[#6FB5E9] text-white font-haas font-semibold rounded mt-6">
