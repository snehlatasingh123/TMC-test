  ...
  return (
    <footer className="bg-[#363839] w-full text-white p-8">
      ...
      <div className="flex flex-col items-center">
        {/* Logo */}
        <Image src="/tmc-footer-logo.svg" alt="The Morning Context Logo" width={160} height={62} />
      ...
      <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-6 text-sm">
        <div>
          ...
          <p className="font-normal font-haas text-base mb-3 text-red-500">INTERNET</p>
          <p className="font-normal font-haas text-base mb-3 text-green-500">BUSINESS</p>
          <p className="font-normal font-haas text-base mb-3 text-purple-500">CHAOS</p>
          <p className="font-normal font-haas text-base mb-3 text-yellow-500">NEWSLETTERS</p>
          <p>All Stories</p>
        </div>
        
        <div>
          <h4 className="font-normal font-haas text-lg mb-3">Subscription</h4>
          <p className="font-normal font-haas text-base mb-3">Individual Plans</p>
          <p className="font-normal font-haas text-base mb-3">Corporate Plans</p>
        ...
        <div>
          ...
          <p className="font-normal font-haas text-base mb-3">Editorial code of conduct</p>
        </div>

        <div>
          {/* <h4 className="font-semibold mb-3">Links</h4> */}
          <p className="font-normal font-haas text-base mb-3">The Morning Context Blog - On the record</p>
          <p className="font-normal font-haas text-base mb-8">TMC Subscriber App</p>
      ...
      <div className="text-center text-sm mt-4">
        <p className="font-normal font-haas text-base mb-2">©2020 Slowform Pte Limited</p>
        <p className="font-normal font-haas text-sm mb-2">68 Circular Road, #02-01, 049422, Singapore</p>
