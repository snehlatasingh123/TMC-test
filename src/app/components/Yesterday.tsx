    ...
    <section className="p-4 bg-[#FFF9F1]">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center">
          ...
          {/* Heading */}
          <h2 className="text-lg font-mono font-bold text-[#0D256C] tracking-widest pl-2">
            YESTERDAY
          </h2>
        </div>

        {/* Date */}
        <span className="text-base text-gray-500 font-sans tracking-widest">
          APRIL 12, 2022
        </span>
      </div>
      ...
      {newsItems.map((news, index) => (
        <div
          ...
          className="pl-2 border-l-4 bg-[#F3F5FF] p-4 mb-2 text-gray-700"
        >
          <p className="font-black font-matteoregular text-[#051462] mb-1">
            {news.title}
          </p>
          <p className="text-sm text-[#051462] font-matteolight font-bold">
            {news.content}
          </p>
        </div>
      ))}
